...
export default function Login() {
  return (
    <div className="p-5 bg-white h-[calc(100vh-86px)] flex justify-center">
        ...
        <div className="w-full lg:w-1/2 p-6 md:p-10 space-y-6 bg-[#F2F2F2] rounded-lg lg:rounded-l-lg lg:rounded-r-none h-full">
          ...
          <form className="space-y-4">
            ...
            <div>
              <button
                type="submit"
                className="w-full px-4 py-3 mt-2 transition-all text-white bg-[#0B5D51] rounded-md hover:bg-[#0a483f]"
              >
                SIGN IN
              </button>
            </div>
          ...
          <p className="text-sm text-[#737576] -mt-2">
